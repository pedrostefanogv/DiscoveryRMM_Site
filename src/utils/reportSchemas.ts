...
> = {
  ...
  [ReportDatasetType.AgentLabels]: {
    ...
    allowedOrientations: ["landscape", "portrait"],
    defaultOrientation: "landscape",
    allowedSortFields: ["label", "sourceType", "agentHostname", "updatedAt"],
    ...
    sampleFilterPresets: [
      {
        name: "Somente Automáticas",
        description: "Labels com origem automática",
        filtersJson: JSON.stringify({ sourceType: "Automatic", limit: 5000 }),
      },
      {
        name: "Todas as Labels",
        description: "Panorama completo de labels",
        filtersJson: JSON.stringify({ limit: 5000 }),
      },
    ],
  },
  ...
  [ReportDatasetType.KnowledgeBase]: {
    scopeType: ReportScopeType.ClientSite,
    dateMode: ReportDateMode.OptionalRange,
    allowedOrientations: ["landscape", "portrait"],
    defaultOrientation: "portrait",
    allowedSortFields: ["title", "category", "author", "updatedAt"],
    ...
    sampleFilterPresets: [
      {
        name: "Base Publicada",
        description: "Somente artigos publicados",
        filtersJson: JSON.stringify({ isPublished: true, limit: 5000 }),
      },
      {
...
export function getDatasetTypeDescription(
  ...
  const descriptions: Record<ReportDatasetType, string> = {
    ...
    [ReportDatasetType.AgentLabels]:
      "Labels automáticas e manuais aplicadas aos agentes",
    [ReportDatasetType.KnowledgeBase]:
      "Artigos e metadados da base de conhecimento",
  };
