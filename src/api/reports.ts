...
const DEFAULT_PREVIEW_FIELDS: Partial<Record<ReportDatasetType, string[]>> = {
  ...
  [ReportDatasetType.AgentMonitoringEvents]: [
    "severity",
    "title",
    "occurredAt",
    "metricKey",
  ],
  [ReportDatasetType.AgentAlerts]: ["name", "severity", "threshold", "metricKey"],
  [ReportDatasetType.P2pTelemetry]: [
    "bytesServed",
    "bytesDownloaded",
    "connectedPeers",
    "collectedAt",
  ],
  [ReportDatasetType.AgentDisks]: [
    "diskName",
    "sizeBytes",
    "freeBytes",
    "healthStatus",
  ],
  [ReportDatasetType.NetworkAdapters]: [
    "adapterName",
    "macAddress",
    "speedMbps",
    "ipAddresses",
  ],
  [ReportDatasetType.ListeningPorts]: ["port", "protocol", "processName", "state"],
  [ReportDatasetType.Printers]: ["printerName", "driverName", "isDefault"],
  [ReportDatasetType.SoftwareCatalog]: ["name", "publisher", "latestVersion", "category"],
  [ReportDatasetType.AutomationScripts]: ["name", "language", "isActive"],
  [ReportDatasetType.AppPackages]: ["name", "publisher", "version", "category"],
  [ReportDatasetType.TicketActivity]: ["ticketId", "action", "changedBy", "createdAt"],
  [ReportDatasetType.TicketEscalations]: ["name", "escalationLevel", "isActive"],
  [ReportDatasetType.CustomFields]: ["entityName", "fieldName", "valueType"],
