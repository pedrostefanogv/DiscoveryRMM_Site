...
function getDatasetLabel(datasetType: ReportDatasetTypeValue): string {
  if (typeof datasetType === "string") {
    ...
    const stringLabels: Record<string, string> = {
      ...
      automaticlabelrules: "Regras de Labels",
      "automatic-label-rules": "Regras de Labels",
      automationexecutions: "Execuções de Automação",
      "automation-executions": "Execuções de Automação",
      agentinventorycomposite: "Inventário Composto",
      "agent-inventory-composite": "Inventário Composto",
      agentmonitoringevents: "Eventos de Monitoramento",
      "agent-monitoring-events": "Eventos de Monitoramento",
      agentalerts: "Alertas de Agentes",
      "agent-alerts": "Alertas de Agentes",
      p2ptelemetry: "Telemetria P2P",
      "p2p-telemetry": "Telemetria P2P",
      agentdisks: "Discos de Agentes",
      "agent-disks": "Discos de Agentes",
      networkadapters: "Adaptadores de Rede",
      "network-adapters": "Adaptadores de Rede",
      listeningports: "Portas em Escuta",
      "listening-ports": "Portas em Escuta",
      printers: "Impressoras",
      softwarecatalog: "Catálogo de Software",
      "software-catalog": "Catálogo de Software",
      automationscripts: "Scripts de Automação",
      "automation-scripts": "Scripts de Automação",
      apppackages: "Pacotes de Aplicativos",
      "app-packages": "Pacotes de Aplicativos",
      ticketactivity: "Atividade de Chamados",
      "ticket-activity": "Atividade de Chamados",
      ticketescalations: "Regras de Escalonamento",
      "ticket-escalations": "Regras de Escalonamento",
