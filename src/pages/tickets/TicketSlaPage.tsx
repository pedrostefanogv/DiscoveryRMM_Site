  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">SLA, calendários e escalonamento</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <div className="space-y-1">
            <p className="text-xs uppercase tracking-wide text-muted">Calendários</p>
        ...
        <Card>
          <div className="space-y-1">
            <p className="text-xs uppercase tracking-wide text-muted">Regras visíveis</p>
        ...
        <Card>
          ...
          <div className="space-y-3">
            ...
            {sortedCalendars.length === 0 && (
              <p className="text-sm text-muted">Nenhum calendário encontrado para o filtro atual.</p>
            )}
      ...
      >
        {holidayCalendarId && holidayDetailQuery.isLoading ? (
          ...
          <p className="text-sm text-muted">Selecione um calendário para gerenciar os feriados.</p>
        ) : (
          <div className="space-y-6">
            <p className="text-sm text-muted">
      ...
      >
        <div className="space-y-3 text-sm text-muted-foreground">
          <div className="flex items-start gap-3 rounded-xl border border-border bg-surface-light p-4">
            ...
            <div>
              <p className="font-medium text-foreground">1. Calendário de SLA</p>
              <p className="mt-1 text-muted">
