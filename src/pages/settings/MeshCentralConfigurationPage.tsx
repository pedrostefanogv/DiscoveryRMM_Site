    ...
    <div className="space-y-3 rounded-lg border border-white/10 bg-white/5 p-3">
      ...
      <div className="max-h-72 space-y-2 overflow-y-auto pr-1">
        ...
        {items.map((item, index) => {
          ...
          const appliedBefore = toText(asRecord.appliedProfileBefore, "N/A");
          const appliedAfter = toText(asRecord.appliedProfileAfter, "N/A");
          const meshBefore = toText(asRecord.meshIdBefore, "N/A");
          const meshAfter = toText(asRecord.meshIdAfter, "N/A");
          const hasDrift = toBool(asRecord.hasDrift, false);
          const successItem = toBool(asRecord.success, false);
          const appliedItem = toBool(asRecord.applied, false);
