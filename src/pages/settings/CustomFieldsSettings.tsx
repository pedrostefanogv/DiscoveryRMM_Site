...
export default function CustomFieldsSettings() {
  ...
  const valuesQuery = useCustomFieldValues(valueScope, valueEntityId, includeSecrets, valueScope === CustomFieldScopeType.Server || Boolean(valueEntityId));
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400">Gerencie definições por escopo e os valores por Servidor, Cliente, Site e Agente.</p>
      </div>
      ...
      <Card>
        <CardHeader title="Valores por Escopo" subtitle="Selecione a entidade e edite os valores das definições correspondentes." />
        <div className="grid gap-4 lg:grid-cols-4">
          <Select label="Escopo" value={selectedValueScope} options={scopeOptions} onChange={event => setSelectedValueScope(event.target.value as StringifiedScope)} />
